					...
					if(this.getStatus() == BMAP_STATUS_SUCCESS){
						...
						$.get('http://api.map.baidu.com/geocoder/v2/?ak=ERtymnt2XAAWdaDdLGE60jqk0pm4Q4kT&callback=renderReverse&location='+r.point.lat+','+r.point.lng+'&output=json&pois=1',function(msg){
							...
							$.get("{{host}}lists/receive_list/distance/"+distance+"/lng/"+lng+"/lat/"+lat,function(msg){
								...
								{
									v=v+'<dl class="index-year" ><a href="month.html" data-transition="slide" data-ajax="false"><dd><div <h4 rowspan="2">'+msg[i].s_title+'</h4></div><div style="float:left; width:40%"><p style="float:none"><small>距离您：</small>'+msg[i].distance+'m</p><p style="float:none"><small>用户星级：</small><img src="{{host}}public/images/star1.gif" width="80" alt=""></p></div></dd><dt><font color="#009dd9">李智渊</font>于'+msg[i].s_time+'发布</dt></a></dl>'
								}
								$("#content").html(v)
							},'json')
						},'jsonp')
