...
/* set_pwd.php */
class __TwigTemplate_32348777f70ff035f315fe2309378318f1edb20185228f5e5bf7f0f3b8f08503 extends Twig_Template
{
...
\t\t<div class=\"ui-content\" data-role=\"content\">
        ...
        // line 19
        echo twig_escape_filter($this->env, (isset($context["host"]) ? $context["host"] : null), "html", null, true);
        echo "set/set_topwd\"  data-ajax=\"false\" >
\t\t\t\t<ul>
                    <li>
                        <label>手机号：</label>
...
\t\t\t\t\t\$(\".loading\").fadeOut();
        ...
        // line 112
        echo twig_escape_filter($this->env, (isset($context["host"]) ? $context["host"] : null), "html", null, true);
        echo "set/old\",{pwd:jps},function(ps){
                        //alert(ps);
                        if(ps!=1){
                            zhe.style.border=\"1px solid red\";
                            return false;
